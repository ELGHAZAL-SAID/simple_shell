...
/**
 * a_end_node - adds a separator found at the end
 * of a sep_list.
...
/**
 * add_line_to_node - adds a command line at the end
 * of a line_list.
 * @head: head of the linked list.
 * @line: command line.
 * Return: address of the head.
...
/**
 * free_ln_in_list - frees a line_list
 * @head: head of the linked list.
 * Return: no return.
 */
